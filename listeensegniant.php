...
while($rows=mysqli_fetch_assoc($query)){
  ...
  echo"<td> <a href='deleteensegnient.php?id=".$id."'> <button class='button'>Suprimer</button></a> </td>";
  echo"<td> <a href='modifiensegnient.php?id=".$id."'><button class='button1'>Modifier</button></a> </td>";
