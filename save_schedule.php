<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] !='POST'){
        echo "<script> alert('Error: Aucune donnée à sauvegarder.'); location.replace('Gesstionsaleadmin.php') </script>";
        $conn->close();
        exit;
    }
    ...
    if($save){
        echo "<script> alert('Planification enregistrée avec succès.'); location.replace('gestionsalleadmin.php') </script>";
    }else{
        echo "<pre>";
