...
<html lang="en">
    ...
    <a href="compt.php">Informatin de Compt</a>
      ...
      <aside id="sidebar">
        <div class="sidebar-title">
          ...
          <span class="material-icons-outlined" onclick="closeSidebar()" placeholder="Rechercher....." >close</span>
        </div>
      ...
      <main class="main-container">
        ...
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." class="recherche" >
  ...
  $requete="SELECT * from tb_etudient";
  ...
  while($rows=mysqli_fetch_assoc($query)){
    ...
    echo "<td>".$rows['Telephon']."</td>";
    
   
    
    echo"<td> <a href='deletetudinat.php?id=".$id."'><button class='button'>Suprimer</button> </a> </td>" ;
    echo"<td> <a href='modifieretudient.php?id=".$id."'><button class='button1'>Modifier</button></a> </td>";
    echo "</tr>";
