...
<html lang="en">
  ...
  <tr >
    <th whidth="">Nom_du_candidat</th>
    <th>Prenom_du_candidat</th>
    <th>Type_du_dosssier</th>
    <th>Date_du_jour</th>
    <th>Supprimer</th>
  ...
  while($rows=mysqli_fetch_assoc($query)){
    ...
    echo"<td> <a href='deletborduro.php?SID=".$SID."'> <button class='button'>Suprimer</button></a> </td>" ;
