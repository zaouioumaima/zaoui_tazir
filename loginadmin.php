    ...
    <div class="container">
      ...
      <div class="login">
        <form  action="" method="post">
          ...
          <a class="cree_compt" href="creecomptadmin.php">Cree un compte</a>
...
if (isset($_POST['login'])){
  ...
  $select = mysqli_query($conn , "SELECT * FROM tb_student WHERE email ='$email' AND mot_de_passe ='$mot_de_passe'");
  ...
  if(is_array($row)){
    ...
    echo'alert(" E-mail ou mot de passe invalid!");';
