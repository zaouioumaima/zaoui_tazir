    ...
    <div class="container">
      ...
      <div class="login">
        <form  action="" method="post">
          ...
          <a class="cree_compt" href="creecomptetudient.php">Cree un compte</a>
...
if (isset($_POST['login'])){
  ...
  $select = mysqli_query($conn , "SELECT * FROM tb_etudient WHERE email ='$email' AND mot_de_passe ='$mot_de_passe'");
  ...
  if(is_array($row)){
    ...
    $_SESSION["departemant"] = $row['departemant'];
    $_SESSION["wilaya"] = $row['wilaya'];
    $_SESSION["universiter"] = $row['universiter'];
    $_SESSION["numero_de_cart_de_etudiant"]=$row['numero_de_cart_de_etudiant'];
    ...
    echo'alert("E-mail ou mot de passe invalide !");';    
    echo'window.location.href = "loginetudiant.php" ';
    echo'</script>';
  }
